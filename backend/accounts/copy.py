    ...
    try:
        ...
        for idx, payment in enumerate(payments):
            ...
            payment_list.append({
                ...
                "currency": "₹" if request.user.country and request.user.country.upper() in ['IN', 'INDIA'] else "$",
...
def build_invoice_pdf(order, payment, invoice_obj):
    ...
    c.drawString(40, 700, f"Amount Paid: ₹{payment.amount_paid}")
...
def Invoice_section(request):
    ...
    for enroll in enrollments:
        ...
        for payment in payments:
            ...
            currency = "₹" if request.user.country == "India" else "$"
            currency_code = "INR" if currency == "₹" else "USD"
