...
def payment_done(request, id, course_url, order_id):
    ...
    try:
        ...
        try:
            ...
            print(f"⚠️ Could not generate/save professional invoice for first payment: {str(e)}")
        ...
        try:
            ...
            print(f"✅ Invoice email sent to admin for first payment")
        except Exception as email_error:
            print(f"⚠️ Error sending invoice email: {str(email_error)}")
    ...
    try:
        ...
        if installment_order:
            ...
            try:
                ...
                # ✅ SEND EMAIL TO ADMIN WITH INVOICE DETAILS
                try:
                    from django.template.loader import render_to_string
                    from django.core.mail import EmailMessage
                    from django.conf import settings
                    ...
                    print(f"✅ Invoice email sent to admin for installment {installment_number}")
                except Exception as email_error:
                    print(f"⚠️ Error sending invoice email: {str(email_error)}")
                ...
                print(f"❌ Error creating invoice for installment: {str(e)}")
